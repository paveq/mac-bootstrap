...
```sh
curl --remote-name https://raw.githubusercontent.com/paveq/mac-bootstrap/master/bootstrap && sh bootstrap 2>&1 | tee ~/bootstrap.log
```

Want to read through the script first?
```sh
curl --remote-name https://raw.githubusercontent.com/paveq/mac-bootstrap/master/bootstrap
less bootstrap
